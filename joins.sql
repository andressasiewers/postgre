...
select count(1) from banco; -- 151 bancos -- contagem nº bancos
...
select count (distinct banco.numero) -- qnts bancos têm agência
from banco
join agencia on agencia.banco_numero = banco.numero;

-- banco com agência e sem agência 438 registros
select banco.numero, banco.nome, agencia.numero, agencia.nome 
from banco
